      ...
      <div class="content container-fluid">
        <div class="page-header">
          <div class="row align-items-center">
            <div class="col">
              <h3 class="page-title active">All properties</h3>
              <ul class="breadcrumb">
            ...
            <div class="col-auto text-right float-right ml-auto">
              ...
              <a href="addproperties.php" class="btn btn-primary">Add Properties<i class="#"></i></a>
            </div>
                ...
                <div class="table-responsive">
                  <table class="table table-hover table-center mb-0 datatable" id="tblData">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT * FROM properties ORDER BY properties.id DESC";
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                              <img src="image/<?php echo $row["image"] ?>" style="height: 200px; " alt="...">
                            </td>
                            ...
                            <td class="text-right">
                              <div class="actions">
                                ...
                                <a href="editproperties.php?id=<?php echo  $row["id"] ?>" class="btn btn-sm bg-success-light ">
                                  <i class="fas fa-pen"></i>
                                </a><br><br>
                                <a href="deleteproperties.php?id=<?php echo  $row["id"] ?>" class="btn btn-sm bg-danger-light" onClick="javascript: return confirm('Please confirm deletion');">
