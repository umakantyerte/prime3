      ...
      <div class="content container-fluid">
        <div class="page-header">
          <div class="row align-items-center">
            <div class="col">
              <h3 class="page-title active">All Service</h3>
              <ul class="breadcrumb">
            ...
            <div class="col-auto text-right float-right ml-auto">
              ...
              <a href="addservices.php" class="btn btn-primary">Add Service<i class="#"></i></a>
            </div>
                    ...
                    <tbody>
                      ...
                      ?>
                          <tr>
                            ...
                            <td class="text-right">
                              <div class="actions">
                                <a href="deleteservices.php?id=<?php echo  $row["id"] ?>" class="btn btn-md bg-danger-light" onClick="javascript: return confirm('Please confirm deletion');">
                            ...
                            <td class="text-right">
                              <div class="actions">
                                <a href="editservices.php?id=<?php echo $row["id"] ?>" class="btn btn-md bg-success-light">
                                  <i class="fas fa-pen"></i>
                                </a>

                                <!-- <a href="deletecourse.php?id=<?php //echo  $row["course_id"] 
                                                                  ?>" class="btn btn-md bg-danger-light" onClick="javascript: return confirm('Please confirm deletion');">
                                                                <i class="fas fa-trash"></i>
                                                            </a> -->
                              </div>
                            </td>
