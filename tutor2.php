                    ...
                    <div class="row">
                        <div class="text-column col-lg-7 col-md-9 col-sm-12">
                            ...
                            <div class="inner-column">
                                ...
                                <h3 class="" style=" font-family: auto !important;font-weight: 100;font-size:45px;text-align: left;text-transform: capitalize;    color: #fff;">Ashish Gupta</h3>
                                <p>I strongly believe that teaching involves more than just delivering information to students; it also entails fostering an open and honest intellectual connection with them. Over seventeen years, I have taught mathematics to A-level, IB Diploma, Key stage-3 & 4, and GCSE students. This experience has ignited a deep passion for helping students grasp fundamental mathematical concepts, which will be a strong foundation for their future careers. I have a proven track record of setting clear and concise learning objectives and employing innovative, suitable, and personalized instructional techniques, significantly improving students' performance in A-Level & GCSE Maths. I also possess the ability to make the subject captivating by incorporating contemporary resources and materials that maintain students' interest and engagement throughout the lesson</p>
                        ...
                        <div class="col-lg-5">
                            <aside class="sidebar-widget info-column">
                                <div class="inner-column3">
                                    ...
                                    <img src="img/nnm.jpg" alt="Course Image" style="width: 100%;filter: brightness(0.8);border-radius: 20px;height: auto;">
                                </div>
                            </aside>
                        </div>
